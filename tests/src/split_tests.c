...
/*   Updated: 2022/02/28 14:57:13 by jallerha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	// char **tab_7 = ft_split(test_7, "hDi");
	...
	// // Check tab_7
	// assert_verbose(ft_strcmp(tab_7[0], ft_strdup("oaju")) == 0, "tab_7[0] is invalid", "tab_7[0] is valid");
	// assert_verbose(ft_strcmp(tab_7[1], ft_strdup("ujlas")) == 0, "tab_7[0] is invalid", "tab_7[0] is valid");
